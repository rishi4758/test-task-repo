        ...
        <Grid container justify="center">
          ...
          <Grid container item xs={12} justify="flex-end">
            <DialogContent style={{ textAlign: "center", height: 300 }}>
              {" "}
              <div className={classes.name}>Someone Changed the Data:</div>
              <div
...
//                 >
//                   {" "}
//                   {props.storage.name} has been increase by{" "}
//                   {props.storage.count}
//                 </div>
//                 <DialogActions>
//                   <Grid container justify="flex-end">
...
//             </Grid>
//             <Grid container item xs={12} justify="flex-end">
//               <DialogContent style={{ textAlign: "center", height: 200 }}>
//                 {" "}
//                 <div className={classes.name}>Someone Changed the Data:</div>
